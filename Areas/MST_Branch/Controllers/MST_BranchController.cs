...
namespace WebApplication4.Areas.MST_Branch.Controllers
{
	public class MST_BranchController : Controller
	{
		...
		[Area("MST_Branch")]
		[Route("MST_Branch/MST_Branch/{Action}")]
		public IActionResult MST_BranchSearch() 
		{
			string str = this.Configuration.GetConnectionString("connectionString");
			SqlConnection conn = new SqlConnection(str);
			conn.Open();
		...
		[Area("MST_Branch")]
		[Route("MST_Branch/MST_Branch/{Action}")]
		public IActionResult MST_BranchSearchData(MST_BranchModel model) 
		{
			string str = this.Configuration.GetConnectionString("connectionString");
			SqlConnection conn = new SqlConnection(str);
			conn.Open();
