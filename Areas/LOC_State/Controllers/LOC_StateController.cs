...
namespace WebApplication4.Areas.LOC_State.Controllers
{
	public class LOC_StateController : Controller
	{
		...
		[Area("LOC_State")]
		[Route("LOC_State/LOC_State/{Action}")]
		public IActionResult LOC_StateSearch() 
		{
			string str = this.Configuration.GetConnectionString("connectionString");
			SqlConnection conn = new SqlConnection(str);
			conn.Open();
		...
		[Area("LOC_State")]
		[Route("LOC_State/LOC_State/{Action}")]
		public IActionResult LOC_StateSearchData(LOC_StateModel model) 
		{
			string str = this.Configuration.GetConnectionString("connectionString");
			SqlConnection conn = new SqlConnection(str);
			conn.Open();
